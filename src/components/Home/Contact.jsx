        ...
        <div className="flex gap-[78px] items-center justify-end">
            <div className="max-w-[745px] flex justify-start flex-col pb-[13px]">
                <div>
                    ...
                    <p className="my-6 font-normal text-[26px] text-[#77798F] leading-[41.6px]">Feel free to reach out to us anytime through email or LinkedIn. We're here to assist you and answer any queries you may have. Let's stay connected!</p>                    
                </div>
                <div className="flex gap-7 pt-[34px] mt-[34px] border-t border-[#182542]">
                    <div><img src={yagna} alt="yagna img" /></div>
                    <div className="flex flex-col gap-2">
                        <h5 className="text-[29px] text-white uppercase tracking-[0.1em] font-medium leading-[33.98px]">Yagna Kusumanchi</h5>
                        <span className="text-base font-normal text-[#77798F]">Founder and CEO of Click Craft</span>
            ...
            <div className="w-[474px] h-[410px] flex justify-end">
